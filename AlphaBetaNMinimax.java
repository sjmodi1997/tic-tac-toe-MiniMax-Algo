...
class Board
{
    ...
    private int changeInScore(int X, int O)
    {
        ...
        if(O==0)
        	change = (int)Math.pow(10, X-1);
        else if(X==0)
        	change = -(int)Math.pow(10, O-1);
        else
        	change = 0;
...
public class AlphaBetaNMinimax
{ 
